...
export const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "rounded-[12px] bg-card text-card-foreground border border-border shadow-xs p-5 mb-5 transition-shadow duration-150 hover:shadow-sm",
        className
      )}
      {...props}
    />
...
export const CardHeader = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn("flex flex-col space-y-1.5 pb-4 border-b border-border/60 mb-4", className)}
      {...props}
    />
  )
);
